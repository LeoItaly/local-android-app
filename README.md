...
- `README.md`
  - the public entry point for the repository
- `first-prompt.md`
  - the first prompt to paste into your IDE chat so the agent knows how to use the repo
- `requirements-for-local-android-skills.md`
...
- `expo-android-local-first-app/`
  - builds the first local Android app and installs a standalone APK on a connected Android phone
- `android-local-app-update/`
  - updates the already installed local Android app by rebuilding and reinstalling a new APK
...
Once the app already exists on the phone, use:
